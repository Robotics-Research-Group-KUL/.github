...
| ├─ [`urXe_driver_crospi`](https://github.com/Robotics-Research-Group-KUL/urxe_driver_crospi) | This package contains a driver for controlling Universal Robots UR CB and e series using crospi_core, based on template_driver_crospi package which uses ROS2 plugins. |
| ├─ [`trossen_widowx_driver_crospi`](https://github.com/Robotics-Research-Group-KUL/trossen_widowx_driver_crospi) | This package contains a driver for controlling the Trossen WidowX robot using crospi_core, based on template_driver_crospi package which uses ROS2 plugins. |
